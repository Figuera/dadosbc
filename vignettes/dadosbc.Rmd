---
title: "Como consultar as séries temporais do Banco Central do Brasil no R"
...
```{r}
if(require(ggplot2)) {
  ggplot2::autoplot(emprego)
} else {
  print("Para ver esse exemplo é necessário ter o pacote ggplot2 instalado.")
}
```
